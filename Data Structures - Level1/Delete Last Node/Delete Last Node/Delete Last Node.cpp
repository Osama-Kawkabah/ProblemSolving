...
// ÏÇáÉ áÍĞİ ÇáÚŞÏÉ ÇáÃæáì İí ÇáŞÇÆãÉ ÇáãÊÓáÓáÉ
void DeleteFirstNode(Node*& head) {
    Node* Current = head;         // ãÄÔÑ ááÚŞÏÉ ÇáÍÇáíÉ
...
// ÏÇáÉ áÍĞİ ÇáÚŞÏÉ ÇáÃÎíÑÉ İí ÇáŞÇÆãÉ ÇáãÊÓáÓáÉ
void DeleteLastNode(Node*& head) {
    ...
    if (Current->next == NULL) {  // ÅĞÇ ßÇäÊ ÇáÚŞÏÉ ÇáÃæáì åí ÇáÚŞÏÉ ÇáæÍíÏÉ
        head = NULL;              // ÊÚííä ÇáÑÃÓ Åáì NULL
        delete Current;           // ÊÍÑíÑ ÇáĞÇßÑÉ ááÚŞÏÉ ÇáãÍĞæİÉ
        return;
    }

    // ÇáÊÍÑß Åáì ÇáÚŞÏÉ ŞÈá ÇáÃÎíÑÉ
    while (Current != NULL && Current->next != NULL) {
        Prev = Current;
        Current = Current->next;
    }

    // ÅÒÇáÉ ÇáÚŞÏÉ ÇáÃÎíÑÉ
    Prev->next = NULL;            // ÊÍÏíË ÇáÑÇÈØ İí ÇáÚŞÏÉ ŞÈá ÇáÃÎíÑÉ áÊÔíÑ Åáì NULL
    delete Current;               // ÊÍÑíÑ ÇáĞÇßÑÉ ááÚŞÏÉ ÇáãÍĞæİÉ
}
