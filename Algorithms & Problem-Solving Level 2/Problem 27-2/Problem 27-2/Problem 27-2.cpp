...
float Check_Avreg_Number(int Array_Loop[100], int ArrayLenght) {

	float Sum_Number = 0;

	for (int i = 0; i < ArrayLenght; i++)
	{
		Sum_Number += Array_Loop[i];
	}
	return Sum_Number / ArrayLenght;
}
...
int main()
{
	...
	cout << "Avreg Number Is : " << Check_Avreg_Number(Array_Loop, ArrayLenght);
